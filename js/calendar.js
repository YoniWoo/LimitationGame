				...
				<header class="calendar__head">
					<div class="calendar__nav">
						...
						<div id='calendar-left-btn' class="calendar__arrow">
							<img class="calendar__arrow-left" src="img/svg/left-grey-arrow.svg" alt="">
						</div>
						<div id='calendar-right-btn' class="calendar__arrow">
							<img class='calendar__arrow-right' src="img/svg/right-grey-arrow.svg" alt="">
						</div>
					</div>
					...
					<table class="calendar__head-days">
						...
						<td class='calendar__head-days-item'>ME</td>
						<td class='calendar__head-days-item'>JE</td>
						<td class='calendar__head-days-item'>VE</td>
