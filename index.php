...
<div class="container">
    ...
    <p><span>Cher recruteur, trouve ici le bon handicapé à embaucher.<br>Sélectionne tes candidats, créé ton combat et engage le survivant dans ton entreprise.</span></p>
...
<div class="compound" id="compound">
    ...
    <div class="categorie">
        ...
        <p id="sous-text">Choisi 4 à 6 candidats qui s’affronteront lors d'un combat. L'unique vainqueur et gagnera sa place au sein de ton entreprise.</p>
        <!-- TRISOMIQUE -->
        ...
        <div class="video" id="video">
            <div class="player">
                <div class="btn-play">
                    <img src="img/svg/play-arrow.svg" alt="">
                </div>
                <video src="ORION_Video.mp4"></video>
            </div>
        </div>
    </div>
</div>
